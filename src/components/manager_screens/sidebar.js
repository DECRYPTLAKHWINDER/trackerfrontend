          ...
          <div className=" d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            <ul className="nav nav-pills d-block w-100 p-auto" id="menu">
              ...
              <li>
                ...
                >
                  <li className="w-100">
                    <Link to="/viewtask" className="nav-link px-0 links">
                      <i className="fa-solid fa-eye me-2"></i>
                      <span className="d-none d-sm-inline">View Tasks</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/addtask" className="nav-link px-0 links">
                      <i className="fa-solid fa-plus me-2"></i>
                      <span className="d-none d-sm-inline">Add Tasks</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/assigntask" className="nav-link px-0 links">
                      <i className="fa-solid fa-check me-2"></i>
                      <span className="d-none d-sm-inline">Assign Task</span>
                    </Link>
                  </li>
                </ul>
              </li>
              <li className="nav-item">
                <Link
                  to="/viewteammembers"
                  className="nav-link align-middle px-0 links"
                >
                  <i className="fa-solid fa-users me-2"></i>
                  <span className="ms-1 d-none d-sm-inline">My Teams</span>
                </Link>
              </li>
            </ul>
            <hr />
