...
const Header = (props) => {
  ...
  return (
    <>
      <div>
        <nav className="col-md-12 d-flex justify-content-between justify-content-center align-items-center mt-2">
          <button
            className="btn btn-default btn-dark mb-2"
          ...
          <div className="user d-flex align-items-baseline profile-area">
            ...
            <h6 className="color admin">
              ...
              <div className="dropdown profile-area">
                ...
                ></button>
                <ul
                  className="dropdown-menu bg-light header-profile text-center"
